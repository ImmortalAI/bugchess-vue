...
const DEFAULT_MESSAGES: Record<string, string[]> = {
  ru: ['Отличный ход!', 'Отлично сыграли!', 'Не ожидал такого хода.', 'Твой ход.', 'Хорошей игры!'],
  en: ['Great move!', 'Well played!', "Didn't see that coming.", 'Your turn.', 'Good game!'],
};

const STORAGE_KEY = 'quick-messages';

const getDefaults = (locale: string): string[] =>
  DEFAULT_MESSAGES[locale] ?? DEFAULT_MESSAGES.ru ?? [];
